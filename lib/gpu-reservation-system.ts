...
export interface GpuReservationSystemStackProps extends cdk.StackProps {
  modelId?: string;
}

export class GpuReservationSystemStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: GpuReservationSystemStackProps) {
    ...
    const userPool = new cognito.UserPool(this, 'AppUserPool', {
      userPoolName: 'gpu-reservation-user-pool',
    ...
    // Lambda実行ロールを作成
    const lambdaRole = new iam.Role(this, 'ApiProxyLambdaRole', {
    ...
    const api = new apigateway.RestApi(this, 'GpuReservationApi', {
      restApiName: 'GPU Reservation API',
      description: 'API for GPU Reservation System',
    ...
    // Cognito Authorizer
    const authorizer = new apigateway.CognitoUserPoolsAuthorizer(this, 'AppAuthorizer', {
